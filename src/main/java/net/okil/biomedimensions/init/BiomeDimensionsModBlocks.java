...
import net.okil.biomedimensions.block.LushCavesDimensionPortalBlock;
...
public class BiomeDimensionsModBlocks {
	...
	public static final DeferredBlock<Block> LUSH_CAVES_DIMENSION_PORTAL;
	static {
		...
		LUSH_CAVES_DIMENSION_PORTAL = REGISTRY.register("lush_caves_dimension_portal", LushCavesDimensionPortalBlock::new);
	}
